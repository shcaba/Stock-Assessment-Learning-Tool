...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    h5("Select indicator and reference point years"),
    textInput(
      "Ct_I_yrs",
      "Indicator years:",
      value = ""
...
#Indicator plots
  ...
  # })
  # 
  # output$stock_time_series_Index <- renderPlotly({
  #   data.plot<-data.sub()
  #   ggplot(data.plot,aes(Year, Index))+
  #     geom_line(col=data.colors[2])+
  #     geom_point(col=data.colors[2])+
  ...
  # })
  # 
  # output$stock_time_series_Lt <- renderPlotly({
  #   data.plot<-data.sub()
  #   ggplot(data.plot,aes(Year, Mean.Length))+
  #     geom_line(col=data.colors[3])+
  #     geom_point(col=data.colors[3])+
